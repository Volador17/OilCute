...
namespace ZedGraph
{
	...
	#region ContextMenu
		...
		{
            if (!this.ZedExpand.ZoomChoose && this.ZedExpand.IsopenDIYDrawFrm)
            {
                //SetSave();      //用户输入图片宽和高，进行图像保存设置
                SaveAs();
            }
            else if (this.ZedExpand.IsopenB)//打开B库
            {
                SaveAs();
            }
		}
        ...
        /// <summary>
        /// set the picture's height and weight
        /// </summary>
        public void SetSave()
        { 
            using (Graphics g = this.CreateGraphics())
            {
                this.MasterPane.ReSize(g, new RectangleF(0,0,794,1123));
            }
            this.MasterPane.GetImage().Save(@"test.png",ImageFormat.Png);

            //恢复
            using(Graphics g = this.CreateGraphics())
            {
                //this.MasterPane.ReSize(g,new RectangleF(0,0,));
            }
        }
		/// <summary>
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void MenuClick_ReferCrudeOil(object sender,System.EventArgs e)
        {
            this.ZedExpand.refOil();
        }
        /// <summary>
        /// 处理右键选项"清除B库“事件
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void MenuClick_ResetB(object sender,System.EventArgs e)
        {
            this.ZedExpand.resetB() ;
        }
        /// <summary>
        /// 处理图像适窗
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void MenuClick_Adjustpic(object sender, System.EventArgs e)
        {
            this.ZedExpand.setDefault(null);
            double addValue = this.GraphPane.XAxis.Scale.Max * 0.2;//适窗时候添加的坐标系数
            this.GraphPane.XAxis.Scale.Max = this.GraphPane.XAxis.Scale.Max + addValue;
            this.GraphPane.XAxis.Scale.Min = this.GraphPane.XAxis.Scale.Min - addValue;
            this.Refresh();
        }
        /// <summary>
        /// 处理图像全屏
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void MenuClick_Resetpic(object sender,System.EventArgs e)
        {
            this.ZedExpand.setDefault(null);//恢复默认
            this.Refresh();
        }
        /// <summary>
        /// 复制表格
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void MenuClick_Copycells(object sender, System.EventArgs e)
        {
            this.ZedExpand.copyCells();
        }
        /// <summary>
        /// 累计值
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void MenuClick_TotalValue(object sender, System.EventArgs e)
        {
            this.ZedExpand.totalValue();
        }
        /// <summary>
        /// GC计算
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void MenuClick_GcCal(object sender, System.EventArgs e)
        {
            this.ZedExpand.gcCal();
        }
        /// <summary>
        /// 处理右键选项"此点不参与计算"事件
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void MenuClick_NotCalCulate(object sender, System.EventArgs e)
        {
            this.ZedExpand.notCalculate();
        }
        /// <summary>
        /// 右键处理此点参与计算事件
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void MenuClick_CalCulate(object sender, System.EventArgs e)
        {
            this.zedExpand.calCulate();
        }
		/// <summary>
