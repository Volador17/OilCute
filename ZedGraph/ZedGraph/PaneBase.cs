...
namespace ZedGraph
{
	...
	#region Fields
        ...
        protected enumTitleLocation _titleLoction = enumTitleLocation.Top;
	#endregion
	...
	#region Properties
        public enumTitleLocation TitleLocation
        {
            get { return _titleLoction; }
            set { _titleLoction = value; }
        }
		/// <summary>
	...
	#region Methods
		...
		public virtual void Draw( Graphics g  )
		{
			...
			// Draw the Pane Title
            DrawTitle(g, scaleFactor, _titleLoction);
		...
		/// represents a linear multiple to be applied to font sizes, symbol sizes, etc.
		/// </param>		
		public void DrawTitle( Graphics g, float scaleFactor ,enumTitleLocation tilteLocation = enumTitleLocation.Top )
		{	
			...
			if ( _title._isVisible )
			{
                ...
                if (tilteLocation == enumTitleLocation.Top)
                {
                ...
                else if (tilteLocation == enumTitleLocation.Bottom)
                {
                    // use the internal fontSpec class to draw the text using user-specified and/or
                    // default attributes.
                    _title._fontSpec.Draw(g, this, _title._text,
                        ...
                        _rect.Bottom - _margin.Bottom * (float)scaleFactor - size.Height / 2.0F + _margin.Bottom * (float)scaleFactor * 0.5F,
