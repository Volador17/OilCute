...
{
    ///<summary>
    ///OilDataBEntity实体类(OilDataB)
    ///</summary>
    [Serializable]
    public partial class OilDataBEntity : OilDataEntity
    {
        #region "Private Variables"
        private Int32 _ID = 0; // 原油数据，数据字段包括实测值和最后一次修改值，历史修改值放在OilDataBModify表。需要时再加载。
        ...
        /// <summary>
        /// 原油数据，数据字段包括实测值和最后一次修改值，历史修改值放在OilDataBModify表。需要时再加载。
        /// </summary>
        public Int32 ID
        {
            set { this._ID = value; }
