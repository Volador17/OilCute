...
namespace RIPP.OilDB.Model
{
    ...
    /// OilDataRow实体类
    /// </summary>
    public partial class OilDataRowEntity
    {
        ...
        #region "构造函数"
        public OilDataRowEntity()
        {

        }

        public OilDataRowEntity(Int32 ID, Int32 oilTablerowID, Int32 oilDataColID)
        {
            this._ID = ID;
        ...
        public OilDataRowEntity(Int32 ID, Int32 oilTablerowID, Int32 oilDataColID, Boolean belongsToA, Boolean belongsToB, Boolean belongsToApp)
        {
            this._ID = ID;
            this._OilTableRowID = oilTablerowID;
            this._OilDataColID = oilDataColID;
